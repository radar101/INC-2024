...
class SmartWeaveGlobal {
    constructor(arweave, contract, evaluationOptions, interactionState, storage) {
        ...
        this.safeArweaveGet = async function (query) {
            return (0, utils_1.safeGet)(`${this.baseArweaveUrl}${query}`);
        };
...
class KV {
    ...
    async get(key) {
        ...
        return (_a = result === null || result === void 0 ? void 0 : result.cachedValue) !== null && _a !== void 0 ? _a : null;
    }
    async del(key) {
        this.checkStorageAvailable();
        const sortKey = this._transaction.sortKey;
