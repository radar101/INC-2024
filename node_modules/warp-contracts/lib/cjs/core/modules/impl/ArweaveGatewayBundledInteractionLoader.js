...
class ArweaveGatewayBundledInteractionLoader {
    ...
    async load(contractId, fromSortKey, toSortKey, evaluationOptions, signal) {
        ...
        if (evaluationOptions.internalWrites) {
            interactions = await this.appendInternalWriteInteractions(contractId, fromBlockHeight, toBlockHeight, interactions, signal);
        }
    ...
    async appendInternalWriteInteractions(contractId, fromBlockHeight, toBlockHeight, interactions, signal) {
        ...
        const innerWritesInteractions = await this.arweaveFetcher.transactions(innerWritesVariables, Number.MAX_SAFE_INTEGER, signal);
